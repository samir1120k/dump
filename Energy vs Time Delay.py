...
if __name__ == '__main__': # Add this to prevent issues in multiprocessing on Windows
    ...
    csv_file_path_pandas = "fitness_summary Time Delay(25 PS).csv"
    ...
    plt.legend()
    plt.savefig("Energy vs Time Delay(25 PS).pdf", format="pdf", bbox_inches="tight", dpi=800) # saved with different name
    plt.show()
    ...
    new_row = {"Time Delay":"Fitness Improvement(%)", "Fitness_Sum_HC_IRS_RA":improvement_GA_IRS_vs_HC_IRS_RA, "Fitness_Sum_HC_IRS":improvement_GA_IRS_vs_HC_IRS, "Fitness_Sum_GA_IRS_RA":improvement_GA_IRS_vs_GA_IRS_RA, "Fitness_Sum_GA_IRS":0, "Fitness_Sum_RS":improvement_GA_IRS_vs_RS}
